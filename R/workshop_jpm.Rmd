...
**Story:** Compare shanges in year-to-year spendings (`change`) by essential categories (`category`)
...
We can combine bothj approaches by plotting small multiples but adding the other categories in the background as grey lines. We also keep the "national Emergency" line but remove redundant labels.
